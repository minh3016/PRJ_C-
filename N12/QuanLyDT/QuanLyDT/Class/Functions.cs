...
namespace QuanLyDT.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Admin-Thính\source\repos\QuanLyDT\QuanLyDT\QuanLyCuaHangDT.mdf;Integrated Security=True";
            Con.Open();                  //Mở kết nối
        }
