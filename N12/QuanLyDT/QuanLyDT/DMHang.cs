...
namespace QuanLyDT
{
    public partial class DMHang : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            dgvHang.Columns[0].HeaderText = "Mã điện thoại";
            dgvHang.Columns[1].HeaderText = "Tên điện thoại";
            dgvHang.Columns[2].HeaderText = "Chất Hãng";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn phải nhập mã điện thoại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtMaHang.Focus();
                return;
            }
            if (txtTenHang.Text.Trim().Length == 0)
            {
                MessageBox.Show("Bạn phải nhập tên điện thoại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtTenHang.Focus();
                return;
            }
